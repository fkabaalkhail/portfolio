...
export const siteConfig = {
  ...
  projects: [
    {
      id: "mawaqeet",
      title: "Mawaqeet",
      description: "Production iOS app on the App Store — prayer times with ISNA and Umm Al-Qura engines, CoreMotion Qibla compass, Hijri calendar with Maghrib-based date transitions, Stripe payments via Dockerized Node.js backend, Apple Pay, and tiered notifications.",
      tech: ["Swift", "SwiftUI", "Node.js", "Docker", "Stripe", "CoreMotion"],
    ...
    },
    {
      id: "mrasem",
      title: "Mrasem",
      description: "Full-stack luxury concierge booking platform for Saudi Arabia — iOS app (SwiftUI), admin dashboard (Next.js), REST API (Node.js) with Supabase backend, phone OTP auth, QR ticketing with Apple Wallet, and bilingual EN/AR UI with full RTL layout.",
      tech: ["SwiftUI", "Next.js", "Node.js", "Supabase", "Vercel", "Apple Wallet"],
  ...
  skillCategories: [
    { name: "Languages", skills: ["Python", "Java", "Swift", "SwiftUI", "JavaScript", "SQL"] },
    { name: "Cloud & DevOps", skills: ["AWS", "GCP", "Azure", "OCI", "Docker", "Kubernetes", "Terraform", "Ansible", "GitHub Actions"] },
    { name: "Backend", skills: ["FastAPI", "Node.js", "PostgreSQL", "MongoDB", "Redis", "Supabase", "Stripe"] },
...
export const stackLayers: StackLayer[] = [
  ...
  },
  {
    ...
    work: [
      ...
      "Dockerised Node.js backend for Stripe and Apple Pay in Mawaqeet",
